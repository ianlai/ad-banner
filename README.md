...
- **GET /admin** 
  - Admin page for ad-provider to post an ad. 
...
There are two html pages. One is for letting end-user to get an ad, and the other one is for letting ad-provider to post an ad. 
...
- *admin.html*
	- Admin page for the ad-provider to add an ad. 
- *admin.js*
