...
This server and the database are both hosted in AWS Cloud9 service for temporary test. We can test the main page, admin page, and the retrive-all API with the following URLs. However, there is no guarantee how long they can run without problem. In case the links broken, the screenshots of them are also attached. 
- Page: Main
	- https://webdevbootcamp-ianlai.c9users.io/  
    \
  ![Alt text](/screenshots/screenshot-page-index.png "Main Page")
 
- Page: Admin
	- https://webdevbootcamp-ianlai.c9users.io/admin  
    \
  ![Alt text](/screenshots/screenshot-page-admin.png "Admin Page")

- API: Retrieving the whole ad list
  - https://webdevbootcamp-ianlai.c9users.io/api/v1/ads/  
    \
  ![Alt text](/screenshots/screenshot-api-all.png "API - Get All ")
...
- Add test code for apiHandler (Jasmine)
